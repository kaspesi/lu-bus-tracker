...
for (row in 1:nrow(pe11020)) {
    ...
    if(is.na(pe11020[row, "CurrentStop"]) || identical(current_prev, "NA")){
      pe11020[row, "CurrentStop"] <- "In-Transit"
    }
...
linearMod <- lm(TimeToNext ~ (CurrentStop+LastStop)*(Timestamp+Latitude+Longitude+Heading), data=pe11020)
summary(linearMod)
